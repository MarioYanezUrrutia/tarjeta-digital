    ...
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-gray-50 px-6 text-center">
      <div className="max-w-md rounded-lg bg-white p-8 shadow">
        ...
        <p className="mt-3 text-sm text-gray-600">
          Recibimos tu regreso desde Mercado Pago. La confirmación del pago
          puede tardar unos segundos en reflejarse. Revisa el estado de tu
          tarjeta en tu panel; si aparece como activa, ¡todo listo!
        </p>
        {ref && <p className="mt-2 text-xs text-gray-400">Orden: {ref}</p>}
