...
import {
  IconWhatsapp, IconPhone, IconMail, IconGlobe, IconPin,
  IconInstagram, IconFacebook, IconLinkedin, IconTiktok, IconYoutube, IconX,
  IconMap, IconUser, IconContactCard,
} from './icons'
...
export default function PlantillaC({ tarjeta }) {
  ...
  const mostrarUbicacionSeccion = mostrar_ubicacion && (direccion || horario)
  const mostrarProductosSeccion = mostrar_productos && productos && productos.length > 0
